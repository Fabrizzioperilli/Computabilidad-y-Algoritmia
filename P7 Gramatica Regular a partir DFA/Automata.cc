...
Grammar Automata::ConvertToGrammar() {
  Symbol no_terminal1("N");
  Symbol no_terminal2("P");
  Symbol init("S");
  std::set<Symbol> symbols_no_terminal = {no_terminal1, no_terminal2};

  return (Grammar(alphabet_, symbols_no_terminal, init));
}
